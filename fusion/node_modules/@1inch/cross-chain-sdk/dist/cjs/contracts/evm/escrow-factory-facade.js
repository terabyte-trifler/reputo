...
const escrow_factory_zksync_js_1 = require("./escrow-factory-zksync.js");
...
class EscrowFactoryFacade {
    ...
    static getFactory(chainId, factoryAddress) {
        switch (chainId) {
            case chains_js_1.NetworkEnum.ZKSYNC:
                return new escrow_factory_zksync_js_1.EscrowFactoryZksync(factoryAddress);
            default:
